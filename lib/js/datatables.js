jQuery(document).ready( function ($) {
                ...
                settings.jqXHR = $.ajax( {
                    ...
                    "success":  function ( json ) {
                        ...
                        if( typeof json.data !== 'undefined' ){
                            ...
                            $('.dataTables_processing_text').html('No results. <a href="#" class="filter_button noresults">Clear Search</a>');
                            $('.filter_button.noresults').click(function(e){
                                e.preventDefault();
    ...
    if( typeof wpvars.auction !== 'undefined' )
        data.auction = wpvars.auction
    if( typeof wpvars.term_id !== 'undefined' )
        data.term_id = wpvars.term_id;
    if( typeof wpvars.term_taxonomy !== 'undefined' )
        data.term_taxonomy = wpvars.term_taxonomy;
